 ...
 * Zustand's persist middleware drops payloads whose version does not
 * match unless a migrate function is provided; without one, a stale
 * browser value would throw during rehydration and tear down the
 * React tree. Returns a partial state to merge, or null to discard
 * the payload and start fresh.
 */
...
export const MODEL_OPTIONS: ReadonlyArray<ModelInfo> = [
  {
    ...
    description:
      "Medium-intelligence model, selected automatically from the provider's live catalog.",
  },
  {
    id: "high_capacity",
    label: "Deep analysis",
    description:
      "Highest-intelligence model available, selected automatically from the provider's live catalog.",
  },
];
