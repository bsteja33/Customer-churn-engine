...
/**
 * A preset is a complete FormValues record plus display metadata.
 * Select fields use the human string ("Yes" / "Month-to-Month"),
 * numeric fields use raw numbers, and unset fields are omitted; the
 * form and Zod schema normalize these to the API contract on submit.
 */
