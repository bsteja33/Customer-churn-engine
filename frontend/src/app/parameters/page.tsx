...
export default function ParametersPage() {
  ...
  // react-hooks/refs: the compiler lint cannot see that react-hook-form
  // only invokes this callback on submit events, never during render.
  // The ref reads below guard in-flight request cancellation.
