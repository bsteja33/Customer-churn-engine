...
def main() -> int:
    ...
    # Serving tiers are resolved at request time from the provider's
    # live model catalog, so no model-id variables are pinned here. Set
    # LLM_STANDARD_MODEL / LLM_HIGH_CAPACITY_MODEL as Space variables
    # manually only if deterministic routing is required.
